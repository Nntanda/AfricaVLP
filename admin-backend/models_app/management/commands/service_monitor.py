"""
Service monitoring command for admin-backend.
...
from models_app.utils.logging_utils import get_logger, log_system_event, log_performance_metric
...
class Command(BaseCommand):
    ...
    def check_all_services(self):
        ...
        health_status['checks']['wellknown_backend'] = self.check_wellknown_backend()
        ...
        # Celery services
        health_status['checks']['celery'] = self.check_celery_services()
    ...
    def check_wellknown_backend(self):
        """Check wellknown-backend service health."""
        start_time = time.time()
        
        try:
            # Try to reach the health endpoint
            response = requests.get(
                'http://wellknown-backend:8001/health/',
