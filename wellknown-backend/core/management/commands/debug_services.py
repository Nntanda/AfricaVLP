"""
Service debugging utilities for wellknown-backend.
...
from core.utils.logging_utils import get_logger, log_system_event
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            '--service',
            type=str,
            choices=['all', 'database', 'redis', 'admin', 'nginx', 'network'],
            default='all',
    ...
    def handle(self, *args, **options):
        ...
        if service == 'all':
            ...
            debug_results['results']['admin'] = self.debug_admin_backend()
    ...
    def debug_admin_backend(self):
        """Debug admin-backend service connectivity."""
        self.stdout.write("\n=== Admin Backend Debug ===")
