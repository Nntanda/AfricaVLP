...
var KTAsideSecondary = function() {
  ...
  var t, e = KTUtil.get("kt_aside_secondary_tab_1"),
    a = KTUtil.get("kt_aside_secondary_tab_2"),
    n = KTUtil.get("kt_aside_secondary_tab_3"),
    o = KTUtil.find(e, ".kt-aside-secondary__content-body"),
    i = KTUtil.find(a, ".kt-aside-secondary__content-body"),
    l = KTUtil.find(n, ".kt-aside-secondary__content-body"),
    r = function(t) {
      var e, a = KTUtil.find(t, ".kt-aside-secondary__content-head");
      KTUtil.find(t, ".kt-aside-secondary__content-body");
      return e = parseInt(KTUtil.getViewPort().height) - parseInt(KTUtil.actualHeight(a)) - 60, KTUtil.isInResponsiveRange("desktop") ? e -= KTUtil.actualHeight(KTUtil.get("kt_header")) : e -= KTUtil.actualHeight(KTUtil.get("kt_header_mobile")), e
    };
  return {
    init: function() {
      $('#kt_aside_secondary_nav a[data-toggle="tab"]').on("click", function(e) {
        t && t.is($(this)) && $("body").hasClass("kt-aside-secondary--expanded") ? KTLayout.closeAsideSecondary() : (t = $(this), KTLayout.openAsideSecondary())
      }), $("#kt_aside_secondary_close").on("click", function(t) {
        KTLayout.closeAsideSecondary()
      }), $('#kt_aside_secondary_nav a[data-toggle="tab"]').on("shown.bs.tab", function(t) {
        KTUtil.scrollUpdate(o), KTUtil.scrollUpdate(i), KTUtil.scrollUpdate(l)
      }), new KTToggle("kt_aside_secondary_mobile_nav_toggler", {
        target: "body",
...
var KTLayout = function() {
  ...
  return {
    init: function() {
      t = KTUtil.get("body"), this.initHeader(), this.initAside(), this.initAsideSecondary(), this.initPageStickyPortlet(), $("#kt_aside_menu, #kt_header_menu").on("click", '.kt-menu__link[href="#"]:not(.kt-menu__toggle)', function(t) {
        swal("", "You have clicked on a non-functional dummy link!"), t.preventDefault()
      })
    },
    initHeader: function() {
      var t, n;
      n = KTUtil.get("kt_header"), (t = KTUtil.attr(n, "data-ktheader-minimize-offset")) && (options.offset.desktop = t), (t = KTUtil.attr(n, "data-ktheader-minimize-mobile-offset")) && (options.offset.mobile = t), new KTHeader("kt_header"), a = new KTOffcanvas("kt_header_menu_wrapper", {
        overlay: !0,
    ...
    initAside: function() {
      ...
      s = KTUtil.get("kt_aside"), KTUtil.get("kt_aside_brand"), d = KTUtil.hasClass(s, "kt-aside--offcanvas-default") ? "kt-aside--offcanvas-default" : "kt-aside", o = new KTOffcanvas("kt_aside", {
        ...
        KTUtil.addClass(t, "kt-aside--minimizing"), KTUtil.transitionEnd(t, function() {
          KTUtil.removeClass(t, "kt-aside--minimizing"), KTUtil.get("kt_page_portlet") && r.updateSticky()
...
"undefined" != typeof module && (module.exports = KTLib);
