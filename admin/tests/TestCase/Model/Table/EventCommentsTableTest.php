...
class EventCommentsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('EventComments') ? [] : ['className' => EventCommentsTable::class];
        $this->EventComments = TableRegistry::getTableLocator()->get('EventComments', $config);
    }
