...
/**
 * AdminSupportsFixture
 */
class AdminSupportsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'fk_conversation_participants_conversations1_idx' => ['type' => 'index', 'columns' => ['status'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'organization_id' => 1,
                'status' => 1,
                'created' => '2020-01-10 09:57:31',
                'modified' => '2020-01-10 09:57:31'
            ],
        ];
        parent::init();
    }
