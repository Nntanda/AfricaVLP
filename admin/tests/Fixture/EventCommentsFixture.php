...
/**
 * EventCommentsFixture
 */
class EventCommentsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'comment_body' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2020-04-26 13:23:22',
                'modified' => '2020-04-26 13:23:22'
            ],
        ];
        parent::init();
    }
