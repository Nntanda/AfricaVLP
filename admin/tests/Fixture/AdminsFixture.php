...
class AdminsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role' => ['type' => 'string', 'length' => 12, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'role' => 'Lorem ipsu',
                'status' => 1,
                'created' => '2019-11-20 14:59:29',
                'modified' => '2019-11-20 14:59:29'
            ],
        ];
        parent::init();
    }
