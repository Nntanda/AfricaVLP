...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
              <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                  <h3 class="kt-subheader__title"><?= __('Edit Volunteering Category') ?></h3>
                  ...
                  <div class="kt-subheader__wrapper">
                    ...
                    <?= __('Back to Volunteering Categories') ?></a>
                  </div>
                </div>
            ...
            <div class="kt-portlet kt-portlet--tabs">
                <div class="kt-portlet__head">
                  <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title"><?= __('Volunteering Category Texts') ?> </h3>
                  </div>
                ...
                <?= $this->Form->create($volunteeringCategory, ['class' => 'bs-validate']) ?>
