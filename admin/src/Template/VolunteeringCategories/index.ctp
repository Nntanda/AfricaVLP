 ...
 * @var \App\Model\Entity\VolunteeringCategory[]|\Cake\Collection\CollectionInterface $volunteeringCategories
 */
?>
            ...
            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
              <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                  <h3 class="kt-subheader__title"><?= __('Volunteering Sectors') ?></h3>
                  ...
                  <div class="kt-subheader__toolbar" id="kt_subheader_search">
                    <span class="kt-subheader__desc" id="kt_subheader_total">
                      <?= $volunteeringCategories->count() ?> <?= __('Total') ?>
                    </span>
                  ...
                  <div class="kt-section">
                    <div class="kt-section__content">
                      <table class="table">
                        ...
                        <tbody>
                        <?php $sn = 1; foreach ($volunteeringCategories as $volunteeringCategory): ?>
                          <tr>
                            <th scope="row"><?= $sn ?></th>
                            <td><?= h($volunteeringCategory->name) ?></td>
                            <td><?= h($this->getStatusLabel($volunteeringCategory->status)) ?></td>
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="kt-nav">
                                      <li class="kt-nav__item">
                                        <a href="<?= $this->Url->build(['action' => 'edit', $volunteeringCategory->id]) ?>" class="kt-nav__link">
...
<!-- <div class="volunteeringCategories index large-9 medium-8 columns content">
    <div class="paginator">
        <ul class="pagination">
