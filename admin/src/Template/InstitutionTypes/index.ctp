 ...
 * @var \App\Model\Entity\InstitutionType[]|\Cake\Collection\CollectionInterface $institutionTypes
 */
?>
            ...
            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
              <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                  <h3 class="kt-subheader__title"><?= __('Institution Types') ?></h3>
                  ...
                  <div class="kt-section">
                    <div class="kt-section__content">
                      <table class="table">
                        ...
                        <tbody>
                        <?php $sn = 1; foreach ($institutionTypes as $institutionType): ?>
                          <tr>
                            <th scope="row"><?= $sn ?></th>
                            <td><?= h($institutionType->name) ?></td>
                            <td><?= h($this->getStatusLabel($institutionType->status)) ?></td>
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="kt-nav">
                                      <li class="kt-nav__item">
                                        <a href="<?= $this->Url->build(['action' => 'edit', $institutionType->id]) ?>" class="kt-nav__link">
