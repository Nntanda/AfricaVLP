 ...
 * @var \App\Model\Entity\ResourceType[]|\Cake\Collection\CollectionInterface $resourceTypes
 */
?>
            ...
            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
              <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                  <h3 class="kt-subheader__title"><?= __('Resource Types') ?></h3>
                  ...
                  <div class="kt-section">
                    <div class="kt-section__content">
                      <table class="table">
                        ...
                        <tbody>
                        <?php $sn = 1; foreach ($resourceTypes as $resourceType): ?>
                          <tr>
                            <th scope="row"><?= $sn ?></th>
                            <td><?= h($resourceType->name) ?></td>
                            <td><?= h($this->getStatusLabel($resourceType->status)) ?></td>
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="kt-nav">
                                      <li class="kt-nav__item">
                                        <a href="<?= $this->Url->build(['action' => 'edit', $resourceType->id]) ?>" class="kt-nav__link">
...
<!-- <div class="resourceTypes index large-9 medium-8 columns content">
    <div class="paginator">
        <ul class="pagination">
