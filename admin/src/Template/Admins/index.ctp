            ...
            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
              <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                  <h3 class="kt-subheader__title"><?= __('Admins') ?></h3>
                      ...
                      <table class="table">
                        ...
                        <?php $sn = 1; foreach ($admins as $admin): ?>
                          <tr>
                            ...
                            <td><?= h($admin->email) ?></td>
                            <td><?= h($admin->role) ?></td>
                            <td> <?= $this->getStatusLabel($admin->status, 'admin') ?> </td>
                            <td>
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="kt-nav">
                                      <li class="kt-nav__item">
                                        <a href="<?= $this->Url->build(['action' => 'edit', $admin->id]) ?>" class="kt-nav__link">
                                        ...
                                        <?php
                                          if($admin->status == ADMIN_STATUS_ACTIVE) {
                                            echo $this->Form->postLink(
                                              ...
                                              ['data' => ['status' => ADMIN_STATUS_INACTIVE], 'class' => 'kt-nav__link', 'escape' => false]
                                            );
                                          } else {
                                            echo $this->Form->postLink(
                                              '<i class="kt-nav__link-icon la la-unlock-alt"></i><span class="kt-nav__link-text">'. __('Activate') .'</span>', 
                                              ['action' => 'edit', $admin->id], 
                                              ['data' => ['status' => ADMIN_STATUS_ACTIVE], 'class' => 'kt-nav__link', 'escape' => false]
                                            );
                                          }
                                        ?>
                                      </li>
