...
<div id="alert"></div>
<?php if ($section == "about_page_subsection"): ?>
            <!-- begin:: Subheader -->
            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
              <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                  <h3 class="kt-subheader__title"><?= __('About Page - Subsections') ?></h3>
                    ...
                    <!--begin::Portlet-->
                        <div class="kt-portlet kt-portlet--tabs">
                            ...
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title"><?= __('Subsection {0}', [$c]) ?> </h3>
                            </div>
                            ...
                            <div class="tab-content">
                                ...
                                <?php
                                    ...
                                    echo $this->Form->control('content', ['class' => 'w-content tinyM tr-input', 'id' => 'w-content-'. $c ]);
                                ?>
                                </div>
                                ...
                                <?php
                                    ...
                                    echo $this->Form->control('_translations.'. \Cake\Core\Configure::read('I18n.languages.fr.locale') .'.content', ['class' => 'w-content tinyM tr-input', 'id' => 'w-content-fr-'. $c ]);
                                ?>
                                </div>
                                ...
                                <?php
                                    ...
                                    echo $this->Form->control('_translations.'. \Cake\Core\Configure::read('I18n.languages.pt.locale') .'.content', ['class' => 'w-content tinyM tr-input', 'id' => 'w-content-pt-'. $c ]);
                                ?>
                                </div>
                                ...
                                <?php
                                    ...
                                    echo $this->Form->control('_translations.'. \Cake\Core\Configure::read('I18n.languages.ar.locale') .'.content', ['class' => 'w-content tinyM tr-input', 'id' => 'w-content-pt-'. $c ]);
                                ?>
                                </div>
                            </div>
...
<?php if ($section == "about_page_main"): ?>
            <!-- begin:: Subheader -->
            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
              <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                  <h3 class="kt-subheader__title"><?= __('About Page - Main Section') ?></h3>
                  <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                </div>
              </div>
            </div>
                ...
                <div class="col-lg-12 widget-group">
                    <!--begin::Portlet-->
                        <div class="kt-portlet kt-portlet--tabs">
                            <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title"><?= __('Main Section', [$c]) ?> </h3>
                            </div>
                            <div class="kt-portlet__head-toolbar">
                                <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-right nav-tabs-line-success nav-tabs-bold" role="tablist">
                                <li class="nav-item">
            ...
            $.ajax({
                ...
                success: function (data) {
                    data.forEach(result => {
                        ...
                        contentId = wGroup.find("."+result.lang+" .w-content").attr('id');
                        console.log(contentId);
                        tinymce.get(contentId).setContent(result.data[1].text)
                    })
