            ...
            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
              <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                  <h3 class="kt-subheader__title"><?= __('Edit Volunteering Role') ?></h3>
            ...
            <div class="kt-portlet kt-portlet--tabs">
                ...
                <div class="kt-portlet__body">
                  <div class="tab-content">
                    ...
                    <?php
                        echo $this->Form->control('_translations.fr_FR.name', ['class' => 'w-name form-control tr-input', 'placeholder' => 'Name']);
                    ?>
                    </div>
                    <div class="tab-pane fade" id="pt" role="tabpanel">
                    <?php
                        echo $this->Form->control('_translations.pt_PT.name', ['class' => 'w-name form-control tr-input', 'placeholder' => 'Name']);
                    ?>
                    </div>
                  </div>
                  <?php
