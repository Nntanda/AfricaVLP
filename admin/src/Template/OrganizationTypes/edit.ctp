            ...
            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
              <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                  <h3 class="kt-subheader__title"><?= __('Edit Organization Type') ?></h3>
                  ...
                  <div class="kt-subheader__wrapper">
                    ...
                    <?= __('Back to Organization Types') ?></a>
                  </div>
                </div>
            ...
            <div class="kt-portlet kt-portlet--tabs">
                <div class="kt-portlet__head">
                  <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title"><?= __('Organization Type Texts') ?> </h3>
                  </div>
                  <div class="kt-portlet__head-toolbar">
                    <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-right nav-tabs-line-success nav-tabs-bold" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#fr" role="tab"><?= \Cake\Core\Configure::read('I18n.languages.ar.nativeName') ?></a>
                      </li>
                      <li class="nav-item">
                ...
                <?= $this->Form->create($organizationType, ['class' => 'bs-validate']) ?>
