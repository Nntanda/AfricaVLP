                    ...
                    <tbody>
                        ...
                        <tr>
                            <td align="center" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; font-family: Open Sans, Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" class="main-txt">
                                ...
                                align="center" class="greetings"><?= __('Hi,'). $first_name ?></h2>
                                ...
                                align="center"><?= __('Your password reset email.') ?></h2>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center" class="other-cnt">
                                                <p style="color:#999999; font-size:14px; line-height:1.4; margin-top:25px;" class="other-txt"><?= __('Click the link / button to reset your password.') ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            bgcolor="#1A5632">
                                                <a href="<?= $this->Url->build($activationUrl) ?>" target="_blank" class="btn" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background: #1A5632; color: #ffffff; display: block; font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; padding: 14px 120px; text-decoration: none;" ><?= __('Reset Password') ?></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" class="other-cnt">
