                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center" class="other-cnt">
                                                <p style="color:#999999; font-size:14px; line-height:1.4; margin-top:25px;" class="other-txt"><?= __('Thank you for registering on the AU VLP platform, You would gain access to the organization on the platform after the AU has approved your application.') ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" class="other-cnt">
