                    ...
                    <tbody>
                        ...
                        <tr>
                            <td align="center" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; font-family: Open Sans, Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" class="main-txt">
                                ...
                                align="center"><?= __('You have been successfully added as an admin to a volunteering organization.') ?></h2>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; border-collapse: collapse !important; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="75%" class="other-tb">
                                    <tbody>
                                        <tr>
                                            ...
                                            bgcolor="#1A5632">
                                                <a href="<?= $this->Url->build($loginUrl) ?>" target="_blank" class="btn" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background: #1A5632; color: #ffffff; display: block; font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; padding: 14px 120px; text-decoration: none;" ><?= __('Login Here') ?></a>
                                            </td>
                                        </tr>
                                        <tr>
