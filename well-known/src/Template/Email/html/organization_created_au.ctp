                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center" class="other-cnt">
                                                <p style="color:#999999; font-size:14px; line-height:1.4; margin-top:25px;" class="other-txt"><?= __('A new organization with name "'.$organization->name .'", has been registered on the platform and is pending activation. Please login to the dashboard to activate organizations') ?></p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
