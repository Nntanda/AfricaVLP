                    ...
                    <tbody>
                        ...
                        <tr>
                            <td align="center" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; font-family: Open Sans, Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" class="main-txt">
                                ...
                                align="center" class="greetings"><?= __('Hi,') .$organization_user->first_name ?></h2>
                                ...
                                align="center"><?= __('An admin has been added to your volunteering organization.') ?></h2>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center" class="other-cnt">
                                                <p style="color:#999999; font-size:14px; line-height:1.4; margin-top:25px;" class="other-txt"><?= __('You added ') ?> <b><?= $user->first_name. ' '. $user->last_name .'('.$user->email.')' ?></b> <?= __(' as a '. $role .'admin to your volunteering organization.') ?></p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
