    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-5">
            <?= $this->Form->create(false, ['type' => 'get']) ?>
                <input type="text" class="form-control search mb-4" value="<?= $search ?>" name="s" placeholder="<?= __('Search Volunteer') ?>">
            <?= $this->Form->end() ?>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-slideout modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="exampleModalLabel"><?= __('Edit Filters') ?> <a href="<?= $this->Url->build(['action'=>'volunteersReport', $organization->id]) ?>"><?= __('Clear all filters') ?></a></h2>
