        ...
        <div id="ar" class="tab-pane fade basic-info">
            ...
            <div class="form-text">
                <?php
                    ...
                    echo $this->Form->control('_translations.'. \Cake\Core\Configure::read('I18n.languages.ar.locale') .'.content', ['placeholder' => 'Title', 'class' => 'w-content form-control tr-input']);
                ?>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="upload-img">
                    <label class="newbtn">
                        <img id="blah" src="<?= $news->image !== null ? $news->image : $this->Url->image('upload.svg') ?>">
