    ...
    <div class="tab-content">
        <div id="en" class="tab-pane active basic-info">
            ...
            <div class="form-group form-text">
                <?php
                    echo $this->Form->control('title', ['placeholder' => 'Title', 'class' => 'w-title form-control tr-input', 'required' => 'true']);
                    echo $this->Form->control('description', ['placeholder' => 'Description', 'class' => 'w-content form-control tr-input', 'required' => 'true']);
                ?>
            </div>
        </div>
        <div id="fr" class="tab-pane fade basic-info">
            <div class="page-title">
                <h3><?= __('Basic Info') //TODO: Use language translation ?></h3> 
            </div>
            <div class="form-group form-text">
                <?php
                    echo $this->Form->control('_translations.'. \Cake\Core\Configure::read('I18n.languages.fr.locale') .'.title', ['placeholder' => 'Title', 'class' => 'w-title form-control tr-input', 'required' => 'true']);
                    echo $this->Form->control('_translations.'. \Cake\Core\Configure::read('I18n.languages.fr.locale') .'.description', ['placeholder' => 'Description', 'class' => 'w-content form-control tr-input', 'required' => 'true']);
                ?>
            </div>
        </div>
        <div id="pt" class="tab-pane fade basic-info">
            ...
            <div class="form-group form-text">
                <?php
                    echo $this->Form->control('_translations.'. \Cake\Core\Configure::read('I18n.languages.pt.locale') .'.title', ['placeholder' => 'Title', 'class' => 'w-title form-control tr-input', 'required' => 'true']);
                    echo $this->Form->control('_translations.'. \Cake\Core\Configure::read('I18n.languages.pt.locale') .'.description', ['placeholder' => 'Description', 'class' => 'w-content form-control tr-input', 'required' => 'true']);
                ?>
            </div>
        </div>
        <div id="ar" class="tab-pane fade basic-info">
            <div class="page-title">
                <h3><?= \Cake\Core\Configure::read('I18n.languages.ar.nativeName') ?> Basic Info</h3>
            </div>
            <div class="form-group form-text">
                <?php
                    echo $this->Form->control('_translations.'. \Cake\Core\Configure::read('I18n.languages.ar.locale') .'.title', ['placeholder' => 'Title', 'class' => 'w-title form-control tr-input', 'required' => 'true']);
                    echo $this->Form->control('_translations.'. \Cake\Core\Configure::read('I18n.languages.ar.locale') .'.description', ['placeholder' => 'Description', 'class' => 'w-content form-control tr-input', 'required' => 'true']);
                ?>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?= $this->Form->control('resource_type_id', ['empty' => __('Select Type'), 'label' => false, 'required' => 'true']) ?>
                </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    data.forEach(result => {
                        ...
                        $("#"+result.lang+" .w-title").trigger('change');
                        $("#"+result.lang+" .w-content").val(result.data[1].text);
                        $("#"+result.lang+" .w-content").trigger('change');
                    })
                },
                complete: function (xhr, result) {
                    btnGrp.html(initBtn);
