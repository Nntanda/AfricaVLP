...
class ForumPostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'forum_thread_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2020-04-07 13:15:48',
                'modified' => '2020-04-07 13:15:48'
            ],
        ];
        parent::init();
    }
