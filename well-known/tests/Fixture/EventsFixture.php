...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'requesting_volunteers' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'has_remunerations' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'fk_events_countries1_idx' => ['type' => 'index', 'columns' => ['country_id'], 'length' => []],
            'fk_events_organizations1_idx' => ['type' => 'index', 'columns' => ['organization_id'], 'length' => []],
            'fk_events_cities1_idx' => ['type' => 'index', 'columns' => ['city_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_events_cities1' => ['type' => 'foreign', 'columns' => ['city_id'], 'references' => ['cities', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_events_countries1' => ['type' => 'foreign', 'columns' => ['country_id'], 'references' => ['countries', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_events_organizations1' => ['type' => 'foreign', 'columns' => ['organization_id'], 'references' => ['organizations', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'start_date' => '2020-03-09 23:45:26',
                'end_date' => '2020-03-09 23:45:26',
                'status' => 1,
                'requesting_volunteers' => 1,
                'has_remunerations' => 1,
                'created' => '2020-03-09 23:45:26',
                'modified' => '2020-03-09 23:45:26',
                'region_id' => 1
            ],
        ];
        parent::init();
